...
<body id="page-top">
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-mycolor3 fixed-top"
		...
		<div class="container justify-content-between">
			...
			%>
				<form action="SaveCreditCapitalServlet" method="POST">
				<input type="submit"
			...
			<div class="row">
				<div class="col-lg-10 mx-auto">
					...
					<div class="container ">
						...
						<!-- <div class="tab-pane fade" id="pills-capital"  aria-labelledby="pills-profile-tab">
        <div class=""> -->
						<form id="formCapital" action="CapitalServlet"
							class="needs-validation" method="POST" novalidate>
							<div class="form-group row">
								<label for="inputAnnuite" class="col-3 col-form-label">Entrez
									votre Anuité :</label>
								<div class="col-9">
									<%
										if (session.getAttribute("annuiterepC") != null) {
									%>
									<input type="number" class="form-control " step="any"
										id="inputAnnuiteC" value=${annuiterepC } name="inputAnnuiteC" placeholder="Annuité"
										required>
										<%}else{ %>
										<input type="number" class="form-control " step="any"
										id="inputAnnuiteC" name="inputAnnuiteC" placeholder="Annuité"
										required>
										<%} %>
							...
							<div class="form-group row">
								<label for="inputDureeC" class="col-3 col-form-label">Précisez
									une durée :</label>
								<div class="col-9">
									<%
										if (session.getAttribute("dureerepC") != null) {
									%>
									<input type="number" class="form-control" value=${dureerepC } id="inputDureeC"
										name="inputDureeC" placeholder="Durée" min="1" 
										required>
										<%}else{ %>
										<input type="number" class="form-control"  id="inputDureeC"
										name="inputDureeC" placeholder="Durée" min="1" 
										required>
										<%} %>
									<div class="invalid-feedback">La durée doit être comprise
										entre 1 et 12.</div>
									<div class="valid-feedback">Valid input.</div>
								</div>
							</div>
							<div class="form-group row">
								<label for="inputTauxC" class="col-3 col-form-label">Spécifiez
									un taux en (%) :</label>
								<div class="col-9">
								<%
										if (session.getAttribute("tauxrepC") != null) {
									%>
									<input type="number" class="form-control" id="inputTauxC"
										name="inputTauxC" value=${tauxrepC } placeholder="Taux en %" min="1" max="100"
										required>
										<%}else{ %>
										<input type="number" class="form-control" id="inputTauxC"
										name="inputTauxC"  placeholder="Taux en %" min="1" max="100"
										required>
										<%} %>
							...
							<div class=" form-group row justify-content-around">
								<input type="submit"
									...
									id="calculerC" value="Calculer" />
							
							</div>

							<%
								if (session.getAttribute("capitalrepC") != null) {
							%>
